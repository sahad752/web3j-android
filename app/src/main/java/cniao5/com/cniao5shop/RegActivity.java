        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    break;
                case 1:
                    Toast.makeText(RegActivity.this, "The passwords entered twice are inconsistent, please confirm!", Toast.LENGTH_SHORT).show();
                    pgb.setVisibility(ProgressBar.GONE);
                    break;
                case 2:
                    Toast.makeText(RegActivity.this, "The wallet name already exists!", Toast.LENGTH_SHORT).show();
                    pgb.setVisibility(ProgressBar.GONE);
                    break;
                default:
                    pgb.setVisibility(ProgressBar.GONE);
