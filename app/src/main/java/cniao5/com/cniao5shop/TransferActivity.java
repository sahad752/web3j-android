...
public class TransferActivity extends AppCompatActivity {
    ...
    public void transfer(View view){
        ...
        if (eth_amount >= user_amount){
            ...
            builder.setTitle("Transfer").setMessage("Insufficient balance！\nYour balance:\t"+user_amount+" ETH\nBut you want to turn:"+eth_amount+" ETH").setPositiveButton("determine",null).show();
        }
        else {

            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setTitle("Transfer").setMessage("Determined to give\n" + add + "\n转" + eth_amount + " ETH吗?").setNeutralButton("cancel", null).setPositiveButton("ok", new DialogInterface.OnClickListener() {
                @Override
