...
//    private Button mbtnLogout;
    ...
    private  void showUser(){
        ...
        mTxtUserName.setText("Switch wallet");
...
*/
    ...
    public void myCurrency(View view){
        //原来用 startActivity(new Intent(getActivity(), MyFavoriteActivity.class),true); If you are not logged in, you can jump directly to login.activity
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        FishAPI fishAPI = FishAPI.getInstance();
        builder.setTitle("Balance").setMessage(fishAPI.getETHBalance().toString()+" ETH\nnote: 1ETH = 10^18 WEI").setPositiveButton("ok", null).show();
    ...
    public void toMyPrivateKey(View view){
        ...
        builder.setTitle("Private key").setMessage(fishAPI.exportPrivateKey()).setNeutralButton("复制", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                ToastUtils.show(getActivity(),"Successful copy");
                //添加到剪切板
    ...
    public void toMyAddress(View view){
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        final FishAPI fishAPI = FishAPI.getInstance();
        builder.setTitle("address").setMessage(fishAPI.getAddress()).setNeutralButton("copy", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                ToastUtils.show(getActivity(),"Successful copy");
                //添加到剪切板
