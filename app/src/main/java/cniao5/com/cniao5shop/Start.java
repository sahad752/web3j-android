        ...
        if (names.size() == 0){
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    builder.setTitle("verification\n").setMessage("please enter " + choice + " Password\n").
                            setView(et).
                            setPositiveButton("determine\n", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    if (inputPass.equals(pass)) {
                                        ToastUtils.showMsg(Start.this, "Successful verification\n");
                                        startUp(choice,pass,fi);
                                    } else {
                                        ToastUtils.showMsg(Start.this, "Verification failed, please try again\n");
                                    }
